//! The Codex harness: transcript parsing and resume arguments.
...
/// The Codex harness. Sessions are JSONL transcript files; the type owns
/// their parsing and the resume arguments. Codex records no session title.
...
impl Codex {
    ...
    /// Reads and parses a Codex transcript file.
    ///
    /// # Errors
    ///
    ...
    /// The `agent.start` arguments that resume a session: Codex resumes by
    /// session id.
    #[must_use]
